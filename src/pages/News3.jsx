...
function News3() {
  ...
  return (
    <>
      ...
      All Software Boxes And Dongles At Best Prices
      </h3>
      <div className="news1">
      ...
      <div className="content py-5">
        <img
          src="http://tk.commonsupport.com/repairplus/wp-content/uploads/2017/02/lat-blog-3.jpg.webp"
          alt="image"
        />
        <div className="row py-4">
          ...
          <div className="col-lg-11">
            <h4>All Software Boxes And Dongles At Best Prices</h4>
