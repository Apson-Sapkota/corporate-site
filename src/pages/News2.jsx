...
function News2() {
  ...
  return (
    ...
    We Offer The Best In Same Day IPhone Repairs Plymouth
    </h3>
    <div className="news1">
    ...
    <div className="content py-5">
      <img
        src="http://tk.commonsupport.com/repairplus/wp-content/uploads/2017/02/lat-blog-2.jpg.webp"
        alt="image"
      />
      <div className="row py-4">
        ...
        <div className="col-lg-11">
          <h4>We Offer The Best In Same Day IPhone Repairs Plymouth</h4>
